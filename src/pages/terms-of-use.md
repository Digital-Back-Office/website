...
The use of any product, service or feature (the "Materials") available through the internet websites accessible at digitalbackoffice.co.uk, blogs.digitalbackoffice.co.uk and other related websites (collectively, the "Website") by any user of the Website ("User" or "You" or "Your" hereafter) shall be governed by the following terms of use. The following terms and conditions will be deemed to have been accepted by the User on usage of the Website. You are requested to read them carefully before you use the services of this site.
